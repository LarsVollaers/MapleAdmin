	...
	if(isset($_POST['name'])){
		$name = $mysqli->real_escape_string($_POST['name']);
 		...
 		if(!$a || strtolower($a['name']) != strtolower($name)){
 			echo'<div class="col-xs-12"><div class="alert alert-dismissible alert-danger">Oh boy! <b><i>"'.$_POST['name'].'"</i></b> does not exist!</div><a href="main" class="btn btn-warning">Back</a><hr/></div>';
 			return;
  		}
		$id = $a['id'];
		...
		<div>
			<div class="col-xs-12 col-lg-2">
				<div class="well well-sm">
					...
					<hr/>
					<a href="main" class="btn btn-warning btn-lg btn-block">Go back</a>
				</div>
			</div>
      ...
      <div class="modal-body">
			...
			<form method="post" action="main">
				<div class="form-group">
					<label class="control-label set_hidden" for="focusedInput">Character name (cannot be changed)</label>
					<input name="name" class="form-control set_hidden" id="focusedInput" type="text" value="'.$c['name'].'" placeholder="Name">
				</div>
		...
		if(isset($_POST['update'])) {
			...
			if($name == "") {
				...
				<div class="page_messages">					
					<div class="alert alert-dismissible alert-success make_hidden">
						<button type="button" class="close" data-dismiss="alert">&times;</button>
						<strong>Saved!</strong> <br>Successfully edited <b style="color:orange;">'.$name.'</b>.<br>Click <a href="#" onclick="myFunction()">here</a> to reload..
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="well">
						...
						<a type="submit" href="logout" class="btn btn-warning btn-lg btn-block">logout</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="well">
					<div class="page_messages">					
						<div class="alert alert-dismissible alert-warning make_hidden">
							<button type="button" class="close" data-dismiss="alert">&times;</button>
							<p>Make sure you are logged in with <b>gm</b> or <b>admin</b> rights.</p>
						</div>
					</div>
						<ul class="breadcrumb">
							DATABASE, Go to:
						...
						<a type="submit" href="login" class="btn btn-success btn-lg btn-block">Login</a>
					</div>
				</div>
			</div>
		</div>
